...
((lambda (x y)
 ...
 4)
; と等価である.
; lookup-variable-valueがxを探索する度に, 記号xは(第一のフレームで)yやzとeq?でないか,
; (第二のフレームで) a, b, c, dやeとeq?でないか決めなければならない.
...
; これは, ある変数アクセス演算を実行する時に,
; どの変数が実行時環境のどのフレームのどの場所にあるかを覚えておくものである.
;
